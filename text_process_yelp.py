...
def build_sst(trainset, devset, testset, num_labels, data_folder, glove_vocab, glove_path):
    ...
    build_dataset(trainset, os.path.join(data_folder, 'train_word2idx.json'), word_vocab, char_vocab,
                  num_labels=num_labels,
                  one_hot=False)
    build_dataset(devset, os.path.join(data_folder, 'dev_word2idx.json'), word_vocab, char_vocab, num_labels=num_labels,
                  one_hot=False)
    build_dataset(testset, os.path.join(data_folder, 'test_word2idx.json'), word_vocab, char_vocab,
                  num_labels=num_labels,
                  one_hot=False)
